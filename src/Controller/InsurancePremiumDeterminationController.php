...
class InsurancePremiumDeterminationController extends DamageCaseController {
	...
	public function indexAction(Request $request): Response {
		...
		if ($form->isSubmitted() && $form->isValid()) {
			...
			$gebaeudedeckung_mindestbeitrag_netto = max(
				120,
				$insurancePremiumDetermination->getTotal() *
				$gebaeudedeckung_mindestbeitrag_faktor *
				1.55 /
				1000
			);
			...
			$gebaeudedeckung_inklusive_graffiti_netto = max(
				120,
				$insurancePremiumDetermination->getTotal() *
				$gebaeudedeckung_inklusive_graffiti_faktor *
				1.55 /
				1000
			);
			...
			$gebaeudedeckung_inklusive_verzicht_netto = max(
				120,
				$insurancePremiumDetermination->getTotal() *
				$gebaeudedeckung_inklusive_verzicht_faktor *
				1.55 /
				1000
			);
			...
			$gebaeudedeckung_mit_unruhe_inklusive_beschaedigung_1_netto = max(
				120,
				$insurancePremiumDetermination->getTotal() *
				$gebaeudedeckung_mit_unruhe_inklusive_beschaedigung_1_faktor *
				1.55 /
				1000
			);
			...
			$gebaeudedeckung_mit_unruhe_inklusive_beschaedigung_1_netto = number_format(
				$gebaeudedeckung_mit_unruhe_inklusive_beschaedigung_1_netto,
				2,
				",",
				"."
			);
			$gebaeudedeckung_mit_unruhe_inklusive_beschaedigung_1_brutto = number_format(
				$gebaeudedeckung_mit_unruhe_inklusive_beschaedigung_1_brutto,
				2,
				",",
				"."
			);
			$gebaeudedeckung_mit_unruhe_inklusive_beschaedigung_1_faktor = number_format(
				$gebaeudedeckung_mit_unruhe_inklusive_beschaedigung_1_faktor,
				2,
				",",
				"."
			...
			$gebaeudedeckung_mit_unruhe_inklusive_beschaedigung_2_netto = max(
				120,
				$insurancePremiumDetermination->getTotal() *
				$gebaeudedeckung_mit_unruhe_inklusive_beschaedigung_2_faktor *
				1.55 /
				1000
			);
			...
			$gebaeudedeckung_mit_unruhe_inklusive_beschaedigung_2_netto = number_format(
				$gebaeudedeckung_mit_unruhe_inklusive_beschaedigung_2_netto,
				2,
				",",
				"."
			);
			$gebaeudedeckung_mit_unruhe_inklusive_beschaedigung_2_brutto = number_format(
				$gebaeudedeckung_mit_unruhe_inklusive_beschaedigung_2_brutto,
				2,
				",",
				"."
			);
			$gebaeudedeckung_mit_unruhe_inklusive_beschaedigung_2_faktor = number_format(
				$gebaeudedeckung_mit_unruhe_inklusive_beschaedigung_2_faktor,
				2,
				",",
				"."
			...
			$gebaeudedeckung_mit_unruhe_inklusive_beschaedigung_3_netto = max(
				120,
				$insurancePremiumDetermination->getTotal() *
				$gebaeudedeckung_mit_unruhe_inklusive_beschaedigung_3_faktor *
				1.55 /
				1000
			);
			...
			$gebaeudedeckung_mit_unruhe_inklusive_beschaedigung_3_netto = number_format(
				$gebaeudedeckung_mit_unruhe_inklusive_beschaedigung_3_netto,
				2,
				",",
				"."
			);
			$gebaeudedeckung_mit_unruhe_inklusive_beschaedigung_3_brutto = number_format(
				$gebaeudedeckung_mit_unruhe_inklusive_beschaedigung_3_brutto,
				2,
				",",
				"."
			);
			$gebaeudedeckung_mit_unruhe_inklusive_beschaedigung_3_faktor = number_format(
				$gebaeudedeckung_mit_unruhe_inklusive_beschaedigung_3_faktor,
				2,
				",",
				"."
			...
			$gebaeudedeckung_mit_elementar_1_netto = max(
				120,
				$insurancePremiumDetermination->getTotal() *
				$gebaeudedeckung_mit_elementar_1_faktor *
				1.55 /
				1000
			);
			...
			$gebaeudedeckung_mit_elementar_2_netto = max(
				120,
				$insurancePremiumDetermination->getTotal() *
				$gebaeudedeckung_mit_elementar_2_faktor *
				1.55 /
				1000
			);
			...
			$gebaeudedeckung_mit_elementar_3_netto = max(
				120,
				$insurancePremiumDetermination->getTotal() *
				$gebaeudedeckung_mit_elementar_3_faktor *
				1.55 /
				1000
			);
			...
			$gebaeudedeckung_komplett_ohne_gefahren_1_netto = max(
				120,
				$insurancePremiumDetermination->getTotal() *
				$gebaeudedeckung_komplett_ohne_gefahren_1_faktor *
				1.55 /
				1000
			);
			...
			$gebaeudedeckung_komplett_ohne_gefahren_2_netto = max(
				120,
				$insurancePremiumDetermination->getTotal() *
				$gebaeudedeckung_komplett_ohne_gefahren_2_faktor *
				1.55 /
				1000
			);
			...
			$gebaeudedeckung_komplett_ohne_gefahren_3_netto = max(
				120,
				$insurancePremiumDetermination->getTotal() *
				$gebaeudedeckung_komplett_ohne_gefahren_3_faktor *
				1.55 /
				1000
			);
			...
			$gebaeudedeckung_komplett_mit_gefahren_1_netto = max(
				120,
				$insurancePremiumDetermination->getTotal() *
				$gebaeudedeckung_komplett_mit_gefahren_1_faktor *
				1.55 /
				1000
			);
			...
			$gebaeudedeckung_komplett_mit_gefahren_2_netto = max(
				120,
				$insurancePremiumDetermination->getTotal() *
				$gebaeudedeckung_komplett_mit_gefahren_2_faktor *
				1.55 /
				1000
			);
			...
			$gebaeudedeckung_komplett_mit_gefahren_3_netto = max(
				120,
				$insurancePremiumDetermination->getTotal() *
				$gebaeudedeckung_komplett_mit_gefahren_3_faktor *
				1.55 /
				1000
			);
			...
			if (
				!empty($insurancePremiumDetermination->getNumberOfResidentialUnits()) ||
				!empty($insurancePremiumDetermination->getNumberOfCommerciallyUsedUnits())
			) {
				$haus_und_grundbesitzerhaftpflicht_1_netto = max(
					50,
					$insurancePremiumDetermination->getNumberOfResidentialUnits() * 4 +
					$insurancePremiumDetermination->getNumberOfCommerciallyUsedUnits() * 8
				);
			}
			...
			if (
				...
				$haus_und_grundbesitzerhaftpflicht_2_netto = max(
					50,
					$insurancePremiumDetermination->getNumberOfResidentialUnits() * 5 +
					$insurancePremiumDetermination->getNumberOfCommerciallyUsedUnits() * 10
				);
			}
		...
		if ($form->isSubmitted() && $form->isValid() && $insureButton->isClicked()) {
			if ($this->insure($parameters, $form->getData()))
				$this->addFlash('success', 'Die Daten wurden an Asspick übermittelt. Sie erhalten in Kürze eine E-Mail-Bestätigung.');
		}
	...
	private function sendEmailToAdmin(string $filePath): int {
		/** @var User $user */
		$user = $this->getUser();
